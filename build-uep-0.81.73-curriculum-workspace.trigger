UEP v0.81.73 curriculum workspace candidate
...
runtime-fix: one selector per real course card + no duplicate generated status + delayed roster print refresh after panel open
