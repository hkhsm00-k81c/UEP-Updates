Publish requested: UEP 0.80.91 Desktop OAuth secretless fix
...
Fix: remove all legacy client_secret parameters/setters/constants from Desktop OAuth authorization-code and refresh-token exchange; retain current policy client_id, loopback redirect and spreadsheets.readonly scope.
