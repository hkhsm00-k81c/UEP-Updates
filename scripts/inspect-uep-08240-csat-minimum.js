...
const needles=['function dashboardAdmissionRows','dashboardAdmissionRows=','admissionMinimums','54_수능최저DB','수능최저원문','등급합기준','반영영역수','탐구반영과목수','영어별도기준'];
