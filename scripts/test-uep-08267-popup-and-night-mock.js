...
assert(g.includes('function dashboardAfterProgramsForDay(dayKey)'),'weekly night dashboard function missing');
assert(g.includes('function afterSchoolProgramGroups()'),'canonical after-school grouping function missing');
assert(g.includes('const canonical=typeof afterSchoolProgramGroups==="function"?afterSchoolProgramGroups():[];'),'weekly dashboard is not using canonical actual sessions');
