...
node ./scripts/verify-css-cleanup-0.81.17.js app
if($LASTEXITCODE-ne 0){throw '0.81.17 structural CSS verification failed'}
...
if($checks.Values-contains $false){throw 'UEP 0.81.17 runtime anchor verification failed'}
