...
if(!root)throw new Error('usage: node patch-uep-08218-recovery.js <app-root>');
...
must(g.includes('const APP_VERSION = "0.82.14";'),'0.82.14 base version missing');
g=g.replace('const APP_VERSION = "0.82.14";','const APP_VERSION = "0.82.18";');
pkg.version='0.82.18';

const popupMarker='/* UEP_08218_CHANGELOG_POPUP */';
must(!g.includes(popupMarker),'0.82.18 popup already applied');
g+=String.raw`

/* UEP_08218_CHANGELOG_POPUP */
(function uep08218ReleaseNotes(){
  const VERSION='0.82.18';
...
console.log('UEP 0.82.18 recovery patch applied on v0.82.14 base');
